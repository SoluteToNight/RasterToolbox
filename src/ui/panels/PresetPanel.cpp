...
PresetPanel::PresetPanel(QWidget* parent) : QWidget(parent) {
    ...
    targetPixelSizeXSpin_->setSpecialValueText("源像元大小");
    targetPixelSizeXSpin_->setSuffix(" x");
    ...
    targetPixelSizeYSpin_->setSpecialValueText("源像元大小");
    targetPixelSizeYSpin_->setSuffix(" y");
    ...
    formLayout->addRow("输出像元大小", pixelSizeRow);
